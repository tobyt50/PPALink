...
const ManageAdminsPage = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = useFetch<User[]>(`/admin/admins?${queryParams.toString()}`);
  ...
  const handleCreateAdmin = async (data: AdminFormValues) => {
    const createPromise = adminService.createAdmin(
      data.email,
      data.role as Role
    );
  ...
  const handleRoleUpdate = async (role: Role) => {
    ...
    const updatePromise = adminService.updateAdminRole(
      roleModalState.admin.id,
      role
    );
  ...
  return (
    <>
      ...
      <RoleUpdateModal
        ...
        onClose={() => setRoleModalState({ isOpen: false, admin: null })}
        onSubmit={handleRoleUpdate}
        admin={roleModalState.admin}
      />
      <ConfirmationModal
      ...
      <div className="space-y-5">
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-2 text-gray-600 dark:text-zinc-300">
              Create, manage, and assign roles to administrators.
            </p>
          </div>
        ...
        {error && (
          <div className="rounded-2xl border border-red-200 bg-red-50 dark:bg-red-950/60 p-8 text-center text-red-800 shadow-md dark:shadow-none dark:ring-1 dark:ring-white/10">
            Could not load admin accounts. It's likely you do not have
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <SimpleDropdownItem
                                    onSelect={() =>
                                      setRoleModalState({ isOpen: true, admin })
                                    }
                                  ...
                                  <SimpleDropdownItem
                                    onSelect={() => openDeleteModal(admin)}
                                    className="group text-red-700 hover:bg-red-50 hover:text-red-800 dark:hover:text-red-100"
                                  >
                          ...
                          >
                            <div className="flex items-start justify-between">
                              <div className="flex-1 min-w-0">
                                <h3 className="font-medium text-gray-900 dark:text-zinc-50 text-base mb-1">
                                  {admin.email}
                                </h3>
