  ...
  return (
    <>
      <ConfirmationModal
        ...
        description={`Are you sure you want to ${modalState.action?.toLowerCase()} the account for ${
            ...
            <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                {Object.entries(roleOptions).map(([key, value]) => (
                  <SimpleDropdownItem
                    key={key}
                    onSelect={() => setRoleFilter(key as Role | "ALL")}
                  >
                    {value}
                  </SimpleDropdownItem>
                ))}
              ...
              >
                {Object.entries(statusOptions).map(([key, value]) => (
                  <SimpleDropdownItem
                    key={key}
                    onSelect={() => setStatusFilter(key as UserStatus | "ALL")}
                  >
                    {value}
                  </SimpleDropdownItem>
                ))}
