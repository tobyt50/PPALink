...
export const PlanFormModal = ({
  ...
  const { handleSubmit, formState: { errors, isSubmitting }, reset, register } = methods;
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white dark:bg-zinc-900 p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                  className="text-lg font-semibold leading-6 text-gray-900 dark:text-zinc-50 border-b border-gray-100 dark:border-zinc-800 pb-4"
                >
                  {isEditMode
