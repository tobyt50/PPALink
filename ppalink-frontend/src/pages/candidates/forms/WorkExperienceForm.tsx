...
const resolver: Resolver<WorkExperienceFormValues> = zodResolver(experienceSchema);
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mt-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <Input id="endDate" type="date" {...register('endDate')} disabled={isCurrentJob} />
                      {errors.endDate && <p className="text-xs text-red-500">{errors.endDate.message}</p>}
                    </div>
                  </div>

                  <div className="flex items-center space-x-2">
                    <input id="isCurrent" type="checkbox" className="h-4 w-4 rounded" {...register('isCurrent')} />
