...
const InvitationCard = ({
  ...
  <div className="px-4 py-4">
    <div className="flex items-center justify-between">
      <div>
        <p className="font-semibold text-gray-800 dark:text-zinc-100 italic">
          {invitation.email}
        </p>
        <p className="text-sm text-gray-500 dark:text-zinc-400">
          Invitation Pending
...
const TeamManagementPage = () => {
  ...
  // Horizontal scroll drag and wheel handling (moved to top for consistent hook order)
  ...
  }, [handleMouseMove, handleMouseUp]); // Removed 'agency' from deps as it's not used inside
  ...
  const handleDeleteInvitation = async () => {
    ...
    const deletePromise = agencyService.deleteInvitation(
      deleteModalState.invitation.id
    );
              ...
              <table className="min-w-full divide-y divide-gray-100">
                <thead className="bg-gray-50 dark:bg-white/5">
                  <tr>
                    <th
                      scope="col"
                      className="px-6 py-3 text-left text-sm font-semibold text-gray-700 dark:text-zinc-200 select-none cursor-grab"
                    >
                      Member
                    </th>
                    <th
          ...
          {members.length === 0 && invitations.length === 0 && (
            <div className="p-8">
              <EmptyState
                ...
                description="Invite your colleagues to collaborate on hiring."
              />
            </div>
          )}
        </div>
