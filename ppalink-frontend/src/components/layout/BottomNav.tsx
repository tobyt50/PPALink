...
const BottomNav = ({ navItems }: { navItems: NavItem[] }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white dark:bg-zinc-900 rounded-t-[2rem] overflow-hidden shadow-2xl shadow-black/5 dark:shadow-black/20 pb-[env(safe-area-inset-bottom)]">
