...
import {
  ...
  ESSENTIAL_ADMIN_NAV_ITEMS,
  ESSENTIAL_SUPER_ADMIN_NAV_ITEMS,
...
const AdminLayout = () => {
  ...
  const fullNavItems =
    user?.role === 'SUPER_ADMIN' ? SUPER_ADMIN_NAV_ITEMS : ADMIN_NAV_ITEMS;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-920 has-[[data-impersonating]]:pt-10">
      ...
      {/* Navbar — non-sticky on mobile, sticky on desktop */}
